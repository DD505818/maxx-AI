# System Information and Prompts

This document collects the system prompts, developer prompt, user prompt, and the available tools exactly as provided in the session.
